...
//
//	@GetMapping("/")
//	public String searchFlights(@RequestParam(required = false) String fromLocation,
//			@RequestParam(required = false) String toLocation, @RequestParam(required = false) String departureDate,
//			@RequestParam(required = false) String tripType, Model model) {
//		System.out.println("Searching flights from " + fromLocation + " to " + toLocation + " on " + departureDate
//				+ " with trip type " + tripType);
//		if (fromLocation == null)
//			return "index";
//		List<AddedFlight> flights = addedflightdaoimpl.searchFlights(fromLocation, toLocation, departureDate);
